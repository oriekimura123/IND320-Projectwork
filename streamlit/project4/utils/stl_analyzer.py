...
def analyze_decompose_STL(
    ...
    if df_filtered.empty:
        ...
        raise ValueError(f"No data found for Area: {area} and Group: {group}. Check data values.")
    ...
    fig.update_layout(
        title={
            'text': f'STL Decomposition of {group} production in {area}, <br>' 
