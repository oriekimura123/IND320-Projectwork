# Projectwork_part1_app/pages/3_Page3.py
...
st.title("Page 3")
st.write("### Interactive Data Visualization of open-meteo-subset.csv")
st.write("###### A plot of the imported data (see below), including header, axis titles and other relevant formatting. A drop-down menu (st.selectbox) choosing any single column in the CSV or all columns together.A selection slider (st.select_slider) to select a subset of the months. Defaults should be the first month.")
