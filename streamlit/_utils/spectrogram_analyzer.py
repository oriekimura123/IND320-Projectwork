...
#) -> Tuple[plt.Figure, pd.DataFrame]:
    ...
    Args:
        ...
        group (str): The production group (e.g., 'hydro').
    ...
    # Apply the filter
    df_filtered = df[df['groupname'] == group]
    ...
    if df_filtered.empty:
        ...
        st.write(f"Error: No data found for Area: {area} and Group: {group}. Cannot perform STFT.")
        return go.Figure()
    ...
    fig = make_subplots(
        ...
        subplot_titles=[
            f'{group.capitalize()} time series in area {area}',
